...
public class Validator {
    ...
    private void validate(ValidationError errors, String root, Object value) {
    ...
    void validateRequired(ValidationError validations, String root, Object obj) {
    ...
    void validateMinLen(ValidationError validations, String root, Object obj) {
        Arrays.stream(obj.getClass().getDeclaredFields()) //
    ...
    void validateMaxLen(ValidationError validations, String root, Object obj) {
        Arrays.stream(obj.getClass().getDeclaredFields()) //
                .filter(field -> field.getType() == String.class) //
    ...
    void validateMinValue(ValidationError validations, String root, Object obj) {
        Arrays.stream(obj.getClass().getDeclaredFields()) //
    ...
    void validateMaxValue(ValidationError validations, String root, Object obj) {
        Arrays.stream(obj.getClass().getDeclaredFields()) //
    ...
    void validateNotEmpty(ValidationError validations, String root, Object obj) {
        Arrays.stream(obj.getClass().getDeclaredFields()) //
    ...
    void validateNested(ValidationError validations, String root, Object obj) {
        Arrays.stream(obj.getClass().getDeclaredFields()) //
